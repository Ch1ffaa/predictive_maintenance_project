...
def presentation_page():
    ...
    with st.sidebar:
        ...
        theme = st.selectbox("Тема", ["blood", "moon", "solarized", "dracula", "simple", "robot-lung"], index=1) 
        height = st.number_input("Высота слайдов", value=620)
        transition = st.selectbox("Переход", ["slide", "convex", "concave", "zoom", "none"], index=2)
    ...
    - **Практическая значимость**: Снижение затрат на обслуживание и предотвращение простоев. Оптимизация ремонтных работ и повышение надежности
    ...
    - **Характеристики**: 
        - 10 000 технических записей
        - 14 рабочих параметров
        - Имитационные данные промышленных процессов
    ...
    - **Импорт данных**: возможность загрузки датасета из UCI репозитория или CSV-файла
    - **Анализ данных**: визуализация и анализ данных
    - **Построение и обучение модели**: выбор и настройка параметров модели
    - **Прогнозирование**: интерфейс для ввода новых данных и получения прогнозирования на их основе
